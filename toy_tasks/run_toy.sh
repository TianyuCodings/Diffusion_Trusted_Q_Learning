...
python toy_main.py --device=0 --env_name=25_gaussian --distill_loss=diffusion --reward_type=near --actor=sac &
...
python toy_main.py --device=0 --env_name=25_gaussian --distill_loss=diffusion --reward_type=hard --actor=sac  --gamma=0.005 --seed=2&

python toy_main.py --device=3 --env_name=25_gaussian --distill_loss=dmd --reward_type=near --actor=implicit  &
python toy_main.py --device=0 --env_name=25_gaussian --distill_loss=dmd --reward_type=far --actor=implicit  --train_epochs=2000&
